...
function showVideo(id) {
	...
	apiRequest("https://www.googleapis.com/youtube/v3/videos",{
		...
		$('.similar > div').html('' +
			...
			'<div data-id="' + id + '"></div><iframe width="100%" height="100%" src="https://www.youtube.com/embed/' + id + '" frameborder="0" allow="accelerometer; gyroscope; picture-in-picture" allowfullscreen></iframe>' +
			'</div></div>' +
