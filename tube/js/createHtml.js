...
function showVideo(id) {
	...
	apiRequest("https://www.googleapis.com/youtube/v3/videos",{
		...
		$('.similar > div').html('' +
			'<div class="col s12" style="padding: 0px;display: block;"><div class="card" style="background-color: transparent;box-shadow: 0 0 0 0;">' + '<a href="http://www.youtube.com/watch?v=' + id + ' " target="_blank"><img width="100%" height="100%" src="yt-b.png"></a>' +
			...
			'</div></div><center><a href="http://www.youtube.com/channel/UC0z_sx9DU-gT5GeR-TWS47A?sub_confirmation=1" target="_blank"><img width="100%" height="100%" src="yt-s.png"></a></center>' +
